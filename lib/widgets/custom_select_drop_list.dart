...
class MySelectDropList extends StatefulWidget {
  final MyOptionItem itemSelected;
  final MyDropListModel dropListModel;
  final Function(MyOptionItem optionItem) onOptionSelected;
  final bool showIcon;
...
class SelectDropListState extends State<MySelectDropList>
    with SingleTickerProviderStateMixin {
  late MyOptionItem optionItemSelected;
  ...
  void initState() {
    super.initState();
    optionItemSelected = MyOptionItem(
        id: widget.itemSelected.id, name: widget.itemSelected.name);
          ...
          SizeTransition(
              ...
              child: Container(
                  height: widget.heightBottomContainer ??
                      widget.dropListModel.listOptionItems.length * 30,
                  margin: const EdgeInsets.only(bottom: 00, left: 2, right: 2),
  ...
  Column _buildDropListOptions(List<MyOptionItem> items, BuildContext context,
  ...
  Widget _buildSubMenu(MyOptionItem item, BuildContext context,
      Color? textColorItem, double textSizeItem) {
    return Padding(
