...
class Recived extends State<RecivedPage> {
  List<RecivedItemModel> listReciveds = <RecivedItemModel>[];
  ...
  void initState() {
    add();
    for (var element in listReciveds) {
      displayListReciveds.add(element);
    }
