...
class GetBackAddressScreen extends GetWidget<GetBackAddressController> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //
            Obx(() =>
                _buildTime(controller.getBackAddressModelObj.value.date.value)),
            SizedBox(height: 18.v),
            //
            _buildAddress(),
  ...
  /// Section Widget
  // Widget _buildTime() {
  Widget _buildTime(controllerGetback) {
  ...
  Future<void> onTapTime() async {
    DateTime? dateTime = await showDatePicker(
      context: Get.context!,
      initialDate: controller.getBackAddressModelObj.value.selectedDate!.value,
