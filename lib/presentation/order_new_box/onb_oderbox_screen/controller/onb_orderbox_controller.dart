// import 'package:lastapp/presentation/order_new_box/onb_orderbox_screen/models/new_box.dart';
// import 'package:lastapp/presentation/order_new_box/onb_orderbox_screen/models/new_box_day.dart';

// import '../../../../core/app_export.dart';
// import '../models/subject_model.dart';
// import '../models/onb_orderbox_model.dart';
...
//   Rx<OnbOrderboxModel> onbOrderboxModelObj = OnbOrderboxModel().obs;
...
//     for (var element in onbOrderboxModelObj.value.dropdownItemList.value) {
//       element.isSelected = false;
//       if (element.id == value.id) {
//         element.isSelected = true;
//       }
//     }
//     onbOrderboxModelObj.value.dropdownItemList.refresh();
//   }

//   onSelected1(dynamic value) {
//     for (var element in onbOrderboxModelObj.value.dropdownItemList1.value) {
//       element.isSelected = false;
//       if (element.id == value.id) {
//         element.isSelected = true;
//       }
//     }
//     onbOrderboxModelObj.value.dropdownItemList1.refresh();
//   }

//   onSelected2(dynamic value) {
//     for (var element in onbOrderboxModelObj.value.dropdownItemList2.value) {
//       element.isSelected = false;
//       if (element.id == value.id) {
//         element.isSelected = true;
//       }
//     }
//     onbOrderboxModelObj.value.dropdownItemList2.refresh();
//   }
